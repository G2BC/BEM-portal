...
const TITLES: Record<string, string> = {
  "/": "BEM - Banco de dados sobre cogumelos comestíveis brasileiros",
  "/pt": "BEM - Banco de dados sobre cogumelos comestíveis brasileiros",
  "/pt/explorar": "Explorar espécies - BEM",
  "/pt/sobre": "Sobre o projeto - BEM",
  "/pt/publicacoes": "Publicações - BEM",
  "/pt/distribuicao": "Distribuição geográfica - BEM",
  "/pt/contato": "Contato - BEM",
  "/pt/colaboradores": "Colaboradores - BEM",
  "/en": "BEM - Brazilian edible mushrooms database",
  "/en/explorar": "Explore species - BEM",
  "/en/sobre": "About the project - BEM",
  "/en/publicacoes": "Publications - BEM",
  "/en/distribuicao": "Geographic distribution - BEM",
  "/en/contato": "Contact - BEM",
  "/en/colaboradores": "Contributors - BEM",
};

const DESCRIPTIONS: Record<string, string> = {
  "/": "Plataforma de divulgação científica sobre cogumelos comestíveis brasileiros com informações taxonômicas, distribuição e publicações",
  "/pt":
    "Plataforma de divulgação científica sobre cogumelos comestíveis brasileiros com informações taxonômicas, distribuição e publicações",
  "/pt/explorar":
    "Catálogo para explorar espécies de cogumelos comestíveis brasileiros por classificação e filtros",
  "/pt/sobre": "Conheça objetivos, equipe e contexto científico do projeto BEM",
  ...
  "/pt/colaboradores": "Conheça as pessoas e instituições que constroem o BEM",
  "/en":
    "Scientific outreach platform about Brazilian edible mushrooms with taxonomy, distribution and publications",
  "/en/explorar":
    "Catalog to explore Brazilian edible mushroom species with filters and classification",
  "/en/sobre": "Learn about the goals, team and scientific context behind BEM",
  ...
  "/en/colaboradores": "Meet the people and institutions building BEM",
};

const BASE_URL = (process.env.VITE_SITE_URL ?? "https://bem.uneb.br").replace(/\/+$/, "");
...
export async function prerender({ url }: PrerenderContext) {
  ...
  const elements = new Set<HeadElement>([
    ...
    { type: "meta", props: { property: "og:site_name", content: "BEM" } },
