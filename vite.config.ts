  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          name: "BEM - Brazilian Edible Mushrooms",
          short_name: "BEM",
          ...
          icons: [
            ...
            { purpose: "any", sizes: "512x512", src: "bem512_rounded.png", type: "image/png" },
          ],
        },
    ...
    server: {
      allowedHosts: ["77f9-186-194-88-130.ngrok-free.app"],
    },
  };
});
